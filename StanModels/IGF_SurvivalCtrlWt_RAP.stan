...
parameters {
  ...
  real beta_Weight;  // slope for weight in survival~IGF + ... model
  real beta_SexF; // slope for sex in survival~IGF + ... model
  real beta_Twin; // slope for twin in survival~IGF + ... model
  real beta_PopSize; // slope for pop size in survival~IGF + ... model
  real beta_MumAge1; // slope for mum age(1) in survival~IGF + ... model
  real beta_MumAge2; // slope for mum age(2) in survival~IGF + ... model
