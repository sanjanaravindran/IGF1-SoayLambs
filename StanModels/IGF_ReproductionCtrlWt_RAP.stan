...
parameters {
  ...
  real beta_Twin; // slope for twin in repro~IGF + ... model
  real beta_PopSize; // slope for pop size in repro~IGF + ... model
  real beta_MumAge1; // slope for mum age in repro~IGF + ... model
  real beta_MumAge2; // slope for mum age in repro~IGF + ... model
