...
parameters {
  ...
  real beta_Weight; // slope for weight in HornLen~IGF + ... model
  real beta_MumAge1; // slope for mum age(1) in HornLen~IGF + ... model
  real beta_MumAge2; // slope for mum age(2) in HornLen~IGF + ... model
  ...
  real<lower=0> sigma_e; //error sd for hornlen model
