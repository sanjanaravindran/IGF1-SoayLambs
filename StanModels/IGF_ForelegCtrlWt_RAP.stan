data {
  ...
  vector[N] ForeLeg; //Foreleg response
  ...
  vector[N] Weight_sc; //August weight predictor
...
parameters {
  ...
  real beta_Weight; // slope for weight in Foreleg~IGF + ... model
  ...
  real<lower=0> sigma_e; //error sd for Foreleg Model
